...
layer_name = 'fc8-euclidean'

caffe.set_mode_cpu()
net = caffe.Net('memnet/deploy.prototxt',      # defines the structure of the model
                'memnet/memnet.caffemodel',  # contains the trained weights
...
model = load_model('memnet/new.h5', custom_objects={"LRN" : LRN})
